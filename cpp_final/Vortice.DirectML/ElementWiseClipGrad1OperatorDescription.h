...
namespace DirectML {
        ...
        {
                        OperatorType get_OperatorType() const { return OperatorType.ElementWiseClipGrad1; }
        ...
        { $"ElementWiseClipGrad1: MinMaxDataType={MinMaxDataType} Minimum={Minimum} Maximum={Maximum}";
