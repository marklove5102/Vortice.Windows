            ...
            static PixelFormat(void)
        {
                ...
                s_WICFormats = new()
                {
                    ...
                    { Format96bppRGBFloat,          Format.R32G32B32_Float },
                                ...
                                static uint32_t GetBitsPerPixel(Guid guid)
        {
                s_mapGuidToSize.TryGetValue(guid, out uint bitsPerPixel);
                return bitsPerPixel{};
            }

                                    static uint32_t GetStride(Guid guid, uint32_t width)
        {
            ...
            static Format ToDXGIFormat(Guid guid)
        {
            ...
            static uint32_t WICBitsPerPixel(IWICImagingFactory factory, Guid pixelFormat)
        {
                ComponentType type{};
