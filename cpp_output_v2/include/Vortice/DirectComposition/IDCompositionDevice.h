...
#ifndef VORTICE_DIRECTCOMPOSITION_IDCOMPOSITIONDEVICE_H
#define VORTICE_DIRECTCOMPOSITION_IDCOMPOSITIONDEVICE_H
...
#ifndef VORTICE_VORTICE_IDCOMPOSITIONDEVICE_H
#define VORTICE_VORTICE_IDCOMPOSITIONDEVICE_H
...
{
public:
    ~IDCompositionDevice() = default;

    bool CheckDeviceState() { CheckDeviceState(out RawBool result).CheckError();
        return result; }
    ...
    IDCompositionVisual CreateVisual() { CreateVisual(out IDCompositionVisual visual).CheckError();
        return visual; }
...
#endif // VORTICE_VORTICE_IDCOMPOSITIONDEVICE_H

} // namespace Vortice

#endif // VORTICE_DIRECTCOMPOSITION_IDCOMPOSITIONDEVICE_H
