...
#ifndef VORTICE_DIRECT3D11_DEPTHSTENCILDESCRIPTION_H
#define VORTICE_DIRECT3D11_DEPTHSTENCILDESCRIPTION_H
...
{
public:
    constexpr DepthStencilDescription(bool depthEnable, DepthWriteMask depthWriteMask, ComparisonFunction ComparisonFunction.LessEqual)
    ...
    static DepthStencilDescription None{> new(false, DepthWriteMask.Zero)};
    static DepthStencilDescription Default{> new(true, DepthWriteMask.All)};
    static DepthStencilDescription DepthRead{> new(true, DepthWriteMask.Zero)};
    static DepthStencilDescription DepthReverseZ{> new(true, DepthWriteMask.All, ComparisonFunction.GreaterEqual)};
    static DepthStencilDescription DepthReadReverseZ{> new(true, DepthWriteMask.Zero, ComparisonFunction.GreaterEqual)};
    static bool operator{=(in DepthStencilDescription left, in DepthStencilDescription right)
    {
...
#endif // VORTICE_DIRECT3D11_DEPTHSTENCILDESCRIPTION_H
