...
namespace Direct3D11 {
                                ...
                                public RasterizerDescription(CullMode cullMode, FillMode fillMode)
        {
            ...
            override bool Equals(const std::optional<std::any>& obj) const { return this{}; } (obj is RasterizerDescription other) && Equals(other);

            bool Equals(RasterizerDescription other)
        { this == other;
