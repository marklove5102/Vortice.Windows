...
namespace Debug {
            ...
            class ID3D12InfoQueue1
            {
                public delegate void MessageCallback(MessageCategory category, MessageSeverity severity, MessageId id, const std::string& description) = 0;
                ...
                override void DisposeCore(void* nativePointer, bool disposing)
            {
                ...
                void RegisterMessageCallback(const std::optional<MessageCallback>& callback, MessageCallbackFlags callbackFilterFlags{};
                ...
                static void OnNativeMessageCallback(MessageCategory category, MessageSeverity severity, MessageId id, sbyte* pDescription, void* context)
            {
