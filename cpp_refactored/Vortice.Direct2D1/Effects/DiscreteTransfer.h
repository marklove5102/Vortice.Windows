...
#ifndef VORTICE_DISCRETETRANSFER_H
#define VORTICE_DISCRETETRANSFER_H
            ...
            class DiscreteTransfer : public : ID2D1Effect
            {
                ...
                public unsafe float[] RedTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("RedTable length cannot be 0") = 0;
                        }
                ...
                public unsafe float[] GreenTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("GreenTable length cannot be 0") = 0;
                        }
                ...
                public unsafe float[] BlueTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("BlueTable length cannot be 0") = 0;
                        }
                ...
                public unsafe float[] AlphaTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("AlphaTable length cannot be 0") = 0;
                        }
...
#endif // VORTICE_DISCRETETRANSFER_H