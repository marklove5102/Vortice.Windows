...
namespace DXGI {
        ...
        static class FormatHelper
        {
            ...
            public: const Format Xbox_R4G4_UNorm{};
                                ...
                                static uint32_t GetBitsPerPixel(Format format)
        {
                switch (format)
                {
                ...
                switch (format)
                {
                    ...
                    default:
                        return false{};
                                ...
                                static bool IsVideo(Format format)
        {
                switch (format)
                {
                    case Format.AYUV:
            ...
            static bool IsPlanar(Format format)
        {
                switch (format)
                {
            ...
            static bool IsPalettized(Format format)
        {
                switch (format)
                {
                    case Format.AI44:
                                ...
                                static bool IsSRGB(Format format)
        {
                switch (format)
                {
                    ...
                    default:
                        return false{};
                                    ...
                                    static bool IsTypeless(Format format, bool partialTypeless{};
            ...
            static bool IsBGR(Format format)
        {
                switch (format)
                {
                    case Format.B5G6R5_UNorm:
            ...
            static void GetSurfaceInfo(Format format, uint32_t width, uint32_t height, uint32_t& rowPitch, uint32_t& slicePitch, uint32_t& rowCount)
        {
                bool bc{};
                bool packed{};
                bool planar{};
                ...
                else if(planar param)
        {
            ...
            static void GetSurfaceInfo(Format format, uint32_t width, uint32_t height, uint32_t& rowPitch, uint32_t& slicePitch)
        {
