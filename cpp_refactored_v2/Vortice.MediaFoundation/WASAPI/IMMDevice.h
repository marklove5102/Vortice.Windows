...
namespace MediaFoundation {
        ...
        publicclass IMMDevice
        {
            private: std::optional<IPropertyStore> _propertyStore{};
            public: DeviceStates m_state{};
                public: DeviceStates get_State() const { return GetState(dwState)/* CheckError */;
                    return (DeviceStates)dwState;; }
            public: std::string m_id{};
                public: std::string get_Id() const { return unsafe
                    {
                        void* id{};
                        GetId(new IntPtr(&id));
                        var str{};
                        ...
                        public string InstanceId
            {
                get
                {
                    ...
                    return "Unknown";
                        ...
                        public: DataFlow m_dataFlow{};
                public: DataFlow get_DataFlow() const { return ; }
            }
            publicvoid OpenPropertyStore(StorageAccessMode access)
                {
            ...
            privatevoid DisposePropertyStore(void)
                {
                if (_propertyStore != nullptr)
                {
            ...
            publicoverride std::string ToString(void) FriendlyName;
        }
