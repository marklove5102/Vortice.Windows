...
namespace MediaFoundation {
        ...
        publicclass IMFDXGIDeviceManager
        {
            public uint ResetToken { get; internal set{}; }
            publicResult ResetDevice(ComObject direct3D11Device) ResetDevice(direct3D11Device, ResetToken);
            ...
            publicResult UnlockDevice(void* hDevice) UnlockDevice(hDevice, false);
