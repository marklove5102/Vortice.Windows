...
namespace Direct3D12 {
        ...
        publicclass BuildRaytracingAccelerationStructureInputs
        {
            public: RaytracingAccelerationStructureType m_type{};
            public: RaytracingAccelerationStructureBuildFlags m_flags{};
            public: uint32_t m_descriptorsCount{};
            public: ElementsLayout m_layout{};
            public: uint64_t m_instanceDescriptions{};
