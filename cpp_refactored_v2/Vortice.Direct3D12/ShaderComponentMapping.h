...
namespace Direct3D12 {
        ...
        public static class ShaderComponentMapping
        {
                    ...
                    publicstatic uint32_t Encode(ShaderComponentMappingSource source0, ShaderComponentMappingSource source1, ShaderComponentMappingSource source2, ShaderComponentMappingSource source3)
                {
                return (((((uint)source0) & Mask) |
                    ...
                    publicstatic void Decode(uint32_t mapping, ShaderComponentMappingSource& source0, ShaderComponentMappingSource& source1, ShaderComponentMappingSource& source2, ShaderComponentMappingSource& source3)
                {
                ...
                source3 = Decode(3, mapping);
                    ...
                    publicstatic ShaderComponentMappingSource Decode(int32_t componentToExtract, uint32_t mapping)
                {
