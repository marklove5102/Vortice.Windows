...
namespace Direct3D12 {
        ...
        publicclass GraphicsPipelineStateDescription
        {
            ...
            public: std::optional<StreamOutputDescription> m_streamOutput{};
            public: BlendDescription m_blendState{};
            public: uint32_t m_sampleMask{}; = uint.MaxValue;
            public: RasterizerDescription m_rasterizerState{};
            public: DepthStencilDescription m_depthStencilState{}; = DepthStencilDescription.Default;
            public: std::optional<InputLayoutDescription> m_inputLayout{};
            public: IndexBufferStripCutValue m_indexBufferStripCutValue{};
            public: PrimitiveTopologyType m_primitiveTopologyType{};
            public Format[] RenderTargetFormats
            {
                get => _RTVFormats ??= new Format{};
                set => _RTVFormats = value;
            }
            public: Format m_depthStencilFormat{};
            public: SampleDescription m_sampleDescription{}; = SampleDescription.Default;
            public: int32_t m_nodeMask{};
            public: CachedPipelineState m_cachedPSO{};
            public: PipelineStateFlags m_flags{};
