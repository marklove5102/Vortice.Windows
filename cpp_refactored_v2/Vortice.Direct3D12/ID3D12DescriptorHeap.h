...
namespace Direct3D12 {
        ...
        publicclass ID3D12DescriptorHeap
        {
            ...
            private: uint32_t GetGPUDescriptorHandleForHeapStart__vtbl_index{};
                        publicCpuDescriptorHandle GetCPUDescriptorHandleForHeapStart(void)
                {
                // Implement vkd3d-native behavior on Linux
                // See https://github.com/HansKristian-Work/vkd3d-proton/blob/fc2b6f419008ffc5fbdee8564c70cded29abf7bb/libs/vkd3d/resource.c#L7447 if(void)
                {
                ...
                return ((delegate* unmanaged<nint, CpuDescriptorHandle>)this)(NativePointer);
                        ...
                        publicGpuDescriptorHandle GetGPUDescriptorHandleForHeapStart(void)
                {
                // Implement vkd3d-native behavior on Linux
                // See https://github.com/HansKristian-Work/vkd3d-proton/blob/fc2b6f419008ffc5fbdee8564c70cded29abf7bb/libs/vkd3d/resource.c#L7459 if(void)
                {
