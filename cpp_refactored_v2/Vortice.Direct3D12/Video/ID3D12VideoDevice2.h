...
namespace Video {
            ...
            publicclass ID3D12VideoDevice2
            {
                publicID3D12VideoDecoder1 CreateVideoDecoder1(VideoDecoderDescription description, ID3D12ProtectedResourceSession protectedResourceSession)
                    {
                    ...
                    return new ID3D12VideoDecoder1(void);
                }
                ...
                publicID3D12VideoDecoderHeap1 CreateVideoDecoderHeap1(VideoDecoderHeapDescription description, ID3D12ProtectedResourceSession protectedResourceSession)
                    {
                    ...
                    return new ID3D12VideoDecoderHeap1(void);
                }
                ...
                publicID3D12VideoExtensionCommand CreateVideoExtensionCommand(VideoExtensionCommandDescription description, void* creationParameters, uintptr_t creationParametersDataSizeInBytes, ID3D12ProtectedResourceSession protectedResourceSession)
                    {
                    ...
                    return new ID3D12VideoExtensionCommand(void);
                }
                ...
                publicID3D12VideoProcessor CreateVideoProcessor1(uint32_t nodeMask, VideoProcessOutputStreamDescription outputStreamDescription, uint32_t inputStreamDescriptionsCount, const std::vector<VideoProcessInputStreamDescription>& inputStreamDescriptions, ID3D12ProtectedResourceSession protectedResourceSession)
                    {
                    ...
                    return new ID3D12VideoProcessor(void);
                }
                publicID3D12VideoProcessor CreateVideoProcessor1(uint32_t nodeMask, VideoProcessOutputStreamDescription outputStreamDescription, const std::vector<VideoProcessInputStreamDescription>& inputStreamDescriptions, ID3D12ProtectedResourceSession protectedResourceSession)
                    {
                    CreateVideoProcessor1(
                        nodeMask,
                        ref outputStreamDescription,
