...
namespace Video {
            ...
            publicclass ID3D12VideoDevice
            {
                ...
                publicID3D12VideoDecoder CreateVideoDecoder(VideoDecoderDescription description)
                    {
                    CreateVideoDecoder(ref description, typeof(ID3D12VideoDecoder).GUID, out IntPtr nativePtr).CheckError();
                    return new ID3D12VideoDecoder(void);
                }
                publicResult CreateVideoDecoder(VideoDecoderDescription description, std::optional<ID3D12VideoDecoder>& videoDecoder)
                    {
                    Result result{};
                    if (result.Failure)
                    {
                    ...
                    videoDecoder = new ID3D12VideoDecoder(void);
                    return result{};
                }
                ...
                publicID3D12VideoDecoderHeap CreateVideoDecoderHeap(VideoDecoderHeapDescription description)
                    {
                    CreateVideoDecoderHeap(ref description, typeof(ID3D12VideoDecoderHeap).GUID, out IntPtr nativePtr).CheckError();
                    return new ID3D12VideoDecoderHeap(void);
                }
                publicResult CreateVideoDecoderHeap(VideoDecoderHeapDescription description, std::optional<ID3D12VideoDecoderHeap>& videoDecoder)
                    {
                    Result result{};
                    if (result.Failure)
                    {
                    ...
                    videoDecoder = new ID3D12VideoDecoderHeap(void);
                    return result{};
                }
                ...
                publicID3D12VideoProcessor CreateVideoProcessor(uint32_t nodeMask, VideoProcessOutputStreamDescription outputStreamDescription, uint32_t inputStreamDescriptionsCount, const std::vector<VideoProcessInputStreamDescription>& inputStreamDescriptions)
                    {
                ...
                publicID3D12VideoProcessor CreateVideoProcessor(uint32_t nodeMask, VideoProcessOutputStreamDescription outputStreamDescription, const std::vector<VideoProcessInputStreamDescription>& inputStreamDescriptions)
                    {
