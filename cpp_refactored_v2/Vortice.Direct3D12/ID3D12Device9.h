...
namespace Direct3D12 {
        ...
        publicclass ID3D12Device9
        {
            publicID3D12CommandQueue CreateCommandQueue1(const CommandQueueDescription& description, GUID creatorID)
                {
            ...
            publicResult CreateCommandQueue1(const CommandQueueDescription& description, GUID creatorID, std::optional<ID3D12CommandQueue>& commandQueue)
                {
                Result result{};
                if (result.Failure)
                {
                ...
                commandQueue = new ID3D12CommandQueue(void);
                return result{};
            }
