...
namespace Direct3D12 {
        ...
        publicclass DredPageFaultOutput
        {
            public: uint64_t m_pageFaultVA{};
            public: std::optional<DredAllocationNode> m_headExistingAllocationNode{};
            public: std::optional<DredAllocationNode> m_headRecentFreedAllocationNode{};
