...
namespace Direct3D12 {
        ...
        publicclass RootSignatureDescription1
        {
                ...
                : this(RootSignatureFlags.None)
            {
                                    ...
                                    public RootSignatureDescription1(RootSignatureFlags flags, const std::optional<std::vector<RootParameter1>>& parameters, const std::optional<std::vector<StaticSamplerDescription>>& samplers)
                {
