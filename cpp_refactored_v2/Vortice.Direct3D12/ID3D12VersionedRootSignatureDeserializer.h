...
namespace Direct3D12 {
        ...
        publicclass ID3D12VersionedRootSignatureDeserializer
        {
            publicVersionedRootSignatureDescription GetRootSignatureDescAtVersion(RootSignatureVersion convertToVersion)
                {
                void* ptr{};
                // Marshal the result.
                var result{};
