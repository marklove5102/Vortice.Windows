...
namespace Direct3D12 {
        ...
        publicstruct DepthStencilOperationDescription1
        {
                        public static DepthStencilOperationDescription1 get_Default() const { return new(StencilOperation.Keep, StencilOperation.Keep, StencilOperation.Keep, ComparisonFunction.Always); }
                                                public DepthStencilOperationDescription1(StencilOperation stencilFailOp, StencilOperation stencilDepthFailOp, StencilOperation stencilPassOp, ComparisonFunction stencilFunc, uint8_t stencilReadMask, uint8_t stencilWriteMask)
                {
