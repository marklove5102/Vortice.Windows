...
namespace Direct3D12 {
        ...
        publicstruct HitGroupDescription : : IStateSubObjectDescription, IStateSubObjectDescriptionMarshal
        {
            StateSubObjectType IStateSubObjectDescription.SubObjectType => StateSubObjectType.HitGroup;
                                            public HitGroupDescription(const std::string& hitGroupExport, HitGroupType type, const std::string& anyHitShaderImport, const std::string& closestHitShaderImport, const std::string& intersectionShaderImport)
                {
