...
namespace Direct3D12 {
        ...
        publicstruct RasterizerDescription2
        {
                        ...
                        public static RasterizerDescription2 get_Wireframe() const { return new(CullMode.Back, FillMode.Wireframe); }
                                                                public RasterizerDescription2(CullMode cullMode, FillMode fillMode, bool frontCounterClockwise, float depthBias, float depthBiasClamp, float slopeScaledDepthBias, bool depthClipEnable, LineRasterizationMode lineRasterizationMode, uint32_t forcedSampleCount, ConservativeRasterizationMode conservativeRaster)
                {
                CullMode = cullMode;
                FillMode = fillMode;
