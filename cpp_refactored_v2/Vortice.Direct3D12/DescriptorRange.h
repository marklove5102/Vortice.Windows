...
namespace Direct3D12 {
        ...
        publicstruct DescriptorRange
        {
                                            public DescriptorRange(DescriptorRangeType rangeType, uint32_t numDescriptors, uint32_t baseShaderRegister, uint32_t registerSpace, uint32_t offsetInDescriptorsFromTableStart)
                {
                RangeType = rangeType;
