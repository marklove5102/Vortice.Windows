...
namespace Direct3D12 {
        ...
        publicstruct SamplerDescription
        {
            ...
            public static SamplerDescription get_AnisotropicClamp() const { return new(Filter.Anisotropic, TextureAddressMode.Clamp, TextureAddressMode.Clamp, TextureAddressMode.Clamp); }
                ...
                MaxLOD = maxLOD;
                                                            ...
                                                            public SamplerDescription(Filter filter, TextureAddressMode addressU, TextureAddressMode addressV, TextureAddressMode addressW, float mipLODBias, uint32_t maxAnisotropy, ComparisonFunction comparisonFunction, float minLOD, float maxLOD)
                {
                Filter = filter;
                AddressU = addressU;
                AddressV = addressV;
