...
namespace Direct3D12 {
        ...
        publicclass ID3D12Device3
        {
                        publicResult EnqueueMakeResident(ResidencyFlags flags, const std::vector<ID3D12Pageable>& objects, ID3D12Fence fenceToSignal, uint64_t fenceValueToSignal)
                {
