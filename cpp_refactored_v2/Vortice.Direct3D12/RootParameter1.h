...
namespace Direct3D12 {
        ...
        publicstruct RootParameter1
        {
            private: const RootParameterType _parameterType{};
            private: const Union _union{};
            private: const ShaderVisibility _shaderVisibility{};
            public: RootParameterType get_ParameterType() const { return _parameterType{}; }
            public: RootDescriptorTable1 m_descriptorTable{};
                public: RootDescriptorTable1 get_DescriptorTable() const { return var result{};
            ...
            public: ShaderVisibility get_ShaderVisibility() const { return _shaderVisibility{}; }
