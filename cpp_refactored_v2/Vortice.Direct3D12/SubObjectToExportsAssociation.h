...
namespace Direct3D12 {
        ...
        publicclass SubObjectToExportsAssociation : : IStateSubObjectDescription, IStateSubObjectDescriptionMarshal
        {
            ...
            internal struct __Native
        {
            ...
            unsafe IntPtr IStateSubObjectDescriptionMarshal.__MarshalAlloc(Dictionary<StateSubObject, IntPtr> subObjectLookup)
            {
                ...
                {
                    throw new InvalidOperationException("Associated StateSubObject);
                }
