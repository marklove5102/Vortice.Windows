...
#ifndef VORTICE_DREDALLOCATIONNODE_H
#define VORTICE_DREDALLOCATIONNODE_H
...
namespace Direct3D12 {
            ...
            internal struct __Native
        {
            ...
            internalvoid __MarshalFrom(__Native* @ref)
                ...
                {
                    Next = new DredAllocationNode(void);
...
#endif // VORTICE_DREDALLOCATIONNODE_H