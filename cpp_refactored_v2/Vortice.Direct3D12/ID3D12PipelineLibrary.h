...
namespace Direct3D12 {
        ...
        publicclass ID3D12PipelineLibrary
        {
            publicID3D12PipelineState LoadComputePipeline(const std::string& name, ComputePipelineStateDescription description)
                {
                return LoadComputePipeline(name, description, typeof(ID3D12PipelineState).GUID);
            }
            publicID3D12PipelineState LoadGraphicsPipeline(const std::string& name, GraphicsPipelineStateDescription description)
                {
