...
#ifndef VORTICE_AUTOBREADCRUMBNODE_H
#define VORTICE_AUTOBREADCRUMBNODE_H
...
namespace Direct3D12 {
        ...
        publicclass AutoBreadcrumbNode
        {
            ...
            internal struct __Native
        {
            ...
            internalvoid __MarshalFrom(__Native* @ref)
                ...
                {
                    Next = new AutoBreadcrumbNode(void);
...
#endif // VORTICE_AUTOBREADCRUMBNODE_H