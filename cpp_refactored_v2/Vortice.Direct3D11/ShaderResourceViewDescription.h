...
#ifndef VORTICE_SHADERRESOURCEVIEWDESCRIPTION_H
#define VORTICE_SHADERRESOURCEVIEWDESCRIPTION_H
...
namespace Direct3D11 {
        ...
        publicstruct ShaderResourceViewDescription
        {
                ...
                switch (viewDimension)
                {
                    ...
                    default:
                        break;
                                            ...
                                            public ShaderResourceViewDescription(ID3D11Buffer buffer, Format format, uint32_t firstElement, uint32_t numElements, BufferExtendedShaderResourceViewFlags flags)
                {
                Format = format;
...
#endif // VORTICE_SHADERRESOURCEVIEWDESCRIPTION_H