...
namespace Direct3D11 {
        ...
        public partial struct BlendDescription// : IEquatable<BlendDescription>
        {
            ...
            privatestatic bool IsBlendEnabled(RenderTargetBlendDescription& renderTarget)
                {
            ...
            public static bool operator !=(in BlendDescription left, in BlendDescription right)
                => !(left == right);
            publicoverride bool Equals(const std::optional<std::any>& obj) (obj is BlendDescription other) && Equals(other);
            publicbool Equals(BlendDescription other) this == other;
            ...
            privatestatic bool RenderTargetsAreEqual(const BlendDescription& left, const BlendDescription& right)
                {
                for (int32_t i{}; i < ID3D11BlendState.SimultaneousRenderTargetCount; i++)
                {
            ...
            publicstruct RenderTarget__FixedBuffer
        {
                ...
                public ref RenderTargetBlendDescription this{
                    ...
                    get
                    {
                        return ref AsSpan(void);
                    }
                }
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                publicSpan AsSpan(void)
                {
