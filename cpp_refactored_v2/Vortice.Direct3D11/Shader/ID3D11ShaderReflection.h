...
#ifndef VORTICE_ID3D11SHADERREFLECTION_H
#define VORTICE_ID3D11SHADERREFLECTION_H
...
namespace Shader {
            ...
            publicclass ID3D11ShaderReflection
            {
                ...
                public: Int3 m_threadGroupSize{};
                    public: Int3 get_ThreadGroupSize() const { return GetThreadGroupSize(x, y, z);
                ...
                public ID3D11ShaderReflectionConstantBuffer[] ConstantBuffers
                {
                    get
                    {
                        ...
                        {
                            _constantBuffers = new ID3D11ShaderReflectionConstantBuffer{};
                ...
                publicuint32_t GetThreadGroupSize(Int3& size)
                    {
                    uint32_t totalSize{};
...
#endif // VORTICE_ID3D11SHADERREFLECTION_H