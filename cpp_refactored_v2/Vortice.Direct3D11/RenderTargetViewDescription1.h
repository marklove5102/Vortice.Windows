...
#ifndef VORTICE_RENDERTARGETVIEWDESCRIPTION1_H
#define VORTICE_RENDERTARGETVIEWDESCRIPTION1_H
...
namespace Direct3D11 {
        ...
        publicstruct RenderTargetViewDescription1
        {
                ...
                switch (viewDimension)
                {
                    ...
                    default:
                        break;
                                        ...
                                        public RenderTargetViewDescription1(ID3D11Buffer buffer, Format format, uint32_t firstElement, uint32_t numElements)
                {
                Format = format;
...
#endif // VORTICE_RENDERTARGETVIEWDESCRIPTION1_H