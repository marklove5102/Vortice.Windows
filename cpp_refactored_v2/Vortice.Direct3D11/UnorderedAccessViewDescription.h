...
#ifndef VORTICE_UNORDEREDACCESSVIEWDESCRIPTION_H
#define VORTICE_UNORDEREDACCESSVIEWDESCRIPTION_H
...
namespace Direct3D11 {
        ...
        publicstruct UnorderedAccessViewDescription
        {
                ...
                switch (viewDimension)
                {
                    ...
                    case UnorderedAccessViewDimension.Texture3D:
                        ...
                        break;
                                            ...
                                            public UnorderedAccessViewDescription(ID3D11Buffer buffer, Format format, uint32_t firstElement, uint32_t numElements, BufferUnorderedAccessViewFlags flags)
                {
                Format = format;
...
#endif // VORTICE_UNORDEREDACCESSVIEWDESCRIPTION_H