...
namespace Direct3D11 {
        ...
        publicstruct Texture1DDescription
        {
                                                        public Texture1DDescription(Format format, uint32_t width, uint32_t arraySize, uint32_t mipLevels, BindFlags bindFlags, ResourceUsage usage, CpuAccessFlags cpuAccessFlags, ResourceOptionFlags miscFlags)
                {
