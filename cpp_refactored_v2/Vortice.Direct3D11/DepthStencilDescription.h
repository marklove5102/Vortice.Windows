...
namespace Direct3D11 {
        ...
        publicstruct DepthStencilDescription : : IEquatable<DepthStencilDescription>
        {
            ...
            public static bool operator !=(in DepthStencilDescription left, in DepthStencilDescription right)
                => !(left == right);
            publicoverride bool Equals(const std::optional<std::any>& obj) (obj is DepthStencilDescription other) && Equals(other);
            publicbool Equals(DepthStencilDescription other) this == other;
            publicoverride int32_t GetHashCode(void) HashCode.Combine(DepthEnable, DepthWriteMask, DepthFunc, StencilEnable, StencilReadMask, StencilWriteMask, FrontFace, BackFace);
        }
