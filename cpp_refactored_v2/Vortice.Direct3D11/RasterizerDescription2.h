...
namespace Direct3D11 {
        ...
        publicstruct RasterizerDescription2 : : IEquatable<RasterizerDescription2>
        {
            ...
            public static bool operator !=(in RasterizerDescription2 left, in RasterizerDescription2 right)
                => !(left == right);
            publicoverride bool Equals(const std::optional<std::any>& obj) (obj is RasterizerDescription2 other) && Equals(other);
            publicbool Equals(RasterizerDescription2 other) this == other;
