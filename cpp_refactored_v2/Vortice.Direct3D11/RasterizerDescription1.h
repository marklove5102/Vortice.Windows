...
namespace Direct3D11 {
        ...
        publicstruct RasterizerDescription1 : : IEquatable<RasterizerDescription1>
        {
            ...
            public static bool operator !=(in RasterizerDescription1 left, in RasterizerDescription1 right)
                => !(left == right);
            publicoverride bool Equals(const std::optional<std::any>& obj) (obj is RasterizerDescription1 other) && Equals(other);
            publicbool Equals(RasterizerDescription1 other) this == other;
