...
#ifndef VORTICE_VIDEOPROCESSORCOLORSPACE_H
#define VORTICE_VIDEOPROCESSORCOLORSPACE_H
...
namespace Direct3D11 {
        ...
        publicstruct VideoProcessorColorSpace
        {
            private: uint32_t _bitfield{};
            public uint Usage
            {
...
#endif // VORTICE_VIDEOPROCESSORCOLORSPACE_H