...
namespace Direct3D11 {
        ...
        publicstruct RasterizerDescription : : IEquatable<RasterizerDescription>
        {
                        public static RasterizerDescription get_CullNone() const { return new(CullMode.None, FillMode.Solid); }
                        public static RasterizerDescription get_CullFront() const { return new(CullMode.Front, FillMode.Solid); }
                        public static RasterizerDescription get_CullBack() const { return new(CullMode.Back, FillMode.Solid); }
                        public static RasterizerDescription get_Wireframe() const { return new(CullMode.None, FillMode.Wireframe); }
            ...
            public static bool operator !=(in RasterizerDescription left, in RasterizerDescription right)
                => !(left == right);
            publicoverride bool Equals(const std::optional<std::any>& obj) (obj is RasterizerDescription other) && Equals(other);
            publicbool Equals(RasterizerDescription other) this == other;
