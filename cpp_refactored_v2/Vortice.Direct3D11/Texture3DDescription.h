...
namespace Direct3D11 {
        ...
        publicstruct Texture3DDescription
        {
                                                            public Texture3DDescription(Format format, uint32_t width, uint32_t height, uint32_t depth, uint32_t mipLevels, BindFlags bindFlags, ResourceUsage usage, CpuAccessFlags cpuAccessFlags, ResourceOptionFlags miscFlags)
                {
