...
namespace Effects {
            ...
            publicclass DiscreteTransfer : : ID2D1Effect
            {
                ...
                public unsafe float[] RedTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("RedTable length);
                        }
                ...
                public unsafe float[] GreenTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("GreenTable length);
                        }
                ...
                public unsafe float[] BlueTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("BlueTable length);
                        }
                ...
                public unsafe float[] AlphaTable
                {
                    ...
                    set
                    {
                        if (value.Length == 0)
                        {
                            throw new ArgumentException("AlphaTable length);
                        }
