...
namespace WIC {
        ...
        {
            public delegate Result ColorContextsProvider(uint32_t count, const std::optional<std::vector<IWICColorContext>>& colorContexts, uint32_t& actualCountRef);
            publicstatic Result TryGetColorContexts(ColorContextsProvider getColorContexts, IWICImagingFactory imagingFactory, std::optional<std::vector<IWICColorContext>>& colorContexts)
                {
