...
namespace DirectSound {
        ...
        publicclass CaptureBufferDescription
        {
                        public CaptureBufferDescription(void)
                {
            }
                            public: bool m_waveMapped{};
                public: bool get_WaveMapped() const { return return (Flags & CaptureBufferCapabilitiesFlags.WaveMapped) != 0;; }
                            public: bool m_controlEffects{};
                public: bool get_ControlEffects() const { return return (Flags & CaptureBufferCapabilitiesFlags.ControlEffects) != 0;; }
            ...
            internal struct __Native
        {
            ...
            internalvoid __MarshalFrom(__Native& @ref)
                ...
                if (EffectCount > 0)
                {
                    ...
                    {
                        EffectDescriptions= new CaptureEffectDescription(void);
