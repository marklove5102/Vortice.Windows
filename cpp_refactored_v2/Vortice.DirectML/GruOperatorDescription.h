...
#ifndef VORTICE_GRUOPERATORDESCRIPTION_H
#define VORTICE_GRUOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct GruOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Gru; }
                ...
                public: bool m_linearBeforeReset{};
                publicoverride std::string ToString(void) $"Gru: Direction={Direction} LinearBeforeReset={LinearBeforeReset}";
...
#endif // VORTICE_GRUOPERATORDESCRIPTION_H