...
#ifndef VORTICE_ELEMENTWISEACOSHOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEACOSHOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAcoshOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAcosh; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAcosh";
...
#endif // VORTICE_ELEMENTWISEACOSHOPERATORDESCRIPTION_H