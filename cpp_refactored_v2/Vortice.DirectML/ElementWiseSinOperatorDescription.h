...
#ifndef VORTICE_ELEMENTWISESINOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISESINOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseSinOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseSin; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseSin";
...
#endif // VORTICE_ELEMENTWISESINOPERATORDESCRIPTION_H