...
#ifndef VORTICE_ELEMENTWISEFLOOROPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEFLOOROPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseFloorOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseFloor; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseFloor";
...
#endif // VORTICE_ELEMENTWISEFLOOROPERATORDESCRIPTION_H