...
#ifndef VORTICE_ELEMENTWISERECIPOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISERECIPOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseRecipOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseRecip; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseRecip";
...
#endif // VORTICE_ELEMENTWISERECIPOPERATORDESCRIPTION_H