...
namespace DirectML {
        ...
        publicstruct DiagonalMatrixOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.DiagonalMatrix; }
                public: TensorDescription m_outputTensor{};
                public: int32_t m_offset{};
                public: float m_value{};
                publicoverride std::string ToString(void) $"DiagonalMatrix: Offset={Offset} Value={Value}";
