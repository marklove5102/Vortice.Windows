...
#ifndef VORTICE_ELEMENTWISEABSOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEABSOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAbsOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAbs; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAbs";
...
#endif // VORTICE_ELEMENTWISEABSOPERATORDESCRIPTION_H