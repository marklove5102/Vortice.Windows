...
namespace DirectML {
        ...
        publicstruct MaxPoolingGradOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.MaxPoolingGrad; }
                ...
                publicoverride std::string ToString(void) $"MaxPoolingGrad";
