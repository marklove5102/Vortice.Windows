...
namespace DirectML {
        ...
        publicstruct OneHotOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.OneHot; }
                public: TensorDescription m_indicesTensor{};
                public: TensorDescription m_valuesTensor{};
                public: TensorDescription m_outputTensor{};
                public: int32_t m_axis{};
                publicoverride std::string ToString(void) $"OneHot: Axis={Axis}";
