...
#ifndef VORTICE_SCATTEROPERATORDESCRIPTION_H
#define VORTICE_SCATTEROPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ScatterOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Scatter; }
                ...
                publicoverride std::string ToString(void) $"Scatter: Axis={Axis}";
...
#endif // VORTICE_SCATTEROPERATORDESCRIPTION_H