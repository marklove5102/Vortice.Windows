...
namespace DirectML {
        ...
        publicstruct SplitOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Split; }
                public: TensorDescription m_inputTensor{};
                public TensorDescription[] OutputTensors { get; set; }
                public: int32_t m_axis{};
                publicoverride std::string ToString(void) $"Split: Axis={Axis}";
