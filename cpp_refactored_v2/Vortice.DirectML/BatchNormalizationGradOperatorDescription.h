...
namespace DirectML {
        ...
        publicstruct BatchNormalizationGradOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.BatchNormalizationGrad; }
                ...
                publicoverride std::string ToString(void) $"BatchNormalizationGrad: Epsilon={Epsilon}";
