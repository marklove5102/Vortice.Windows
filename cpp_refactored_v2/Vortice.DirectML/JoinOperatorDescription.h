...
namespace DirectML {
        ...
        publicstruct JoinOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Join; }
                public TensorDescription[] InputTensors { get; set; }
                public: TensorDescription m_outputTensor{};
                public: int32_t m_axis{};
                publicoverride std::string ToString(void) $"Join: Axis={Axis}";
