...
namespace DirectML {
        ...
        publicstruct IntermediateGraphEdgeDescription : : IGraphEdgeDescription, IGraphEdgeDescriptionMarshal
        {
                        public: GraphEdgeType get_GraphEdgeType() const { return GraphEdgeType.Intermediate; }
                ...
                publicoverride std::string ToString(void) $"Intermediate:{(string.IsNullOrEmpty(Name) ? "" : $" Name={Name}")} FromNode={FromNodeIndex}[{FromNodeOutputIndex}] ToNode={ToNodeIndex}[{ToNodeInputIndex}]";
