...
namespace DirectML {
        ...
        publicstruct GraphNodeDescription
        {
                public: IGraphNodeDescription m_description{};
            public GraphNodeDescription(IGraphNodeDescription description)
                {
                Description = description;
            }
                publicoverride std::string ToString(void) $"{Description} as GraphNodeDescription";
