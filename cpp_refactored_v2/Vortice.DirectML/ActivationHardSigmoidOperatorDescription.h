...
#ifndef VORTICE_ACTIVATIONHARDSIGMOIDOPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONHARDSIGMOIDOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationHardSigmoidOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationHardSigmoid; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                public: float m_alpha{};
                public: float m_beta{};
                publicoverride std::string ToString(void) $"ActivationHardSigmoid: Alpha={Alpha} Beta={Beta}";
...
#endif // VORTICE_ACTIVATIONHARDSIGMOIDOPERATORDESCRIPTION_H