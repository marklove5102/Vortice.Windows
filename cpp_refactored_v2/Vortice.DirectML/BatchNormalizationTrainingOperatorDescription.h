...
namespace DirectML {
        ...
        publicstruct BatchNormalizationTrainingOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.BatchNormalizationTraining; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_scaleTensor{};
                public: TensorDescription m_biasTensor{};
                public: std::optional<TensorDescription> m_fusedAddTensor{};
                public: TensorDescription m_outputTensor{};
                public: TensorDescription m_outputMeanTensor{};
                public: TensorDescription m_outputVarianceTensor{};
                public: float m_epsilon{};
                public: std::optional<OperatorDescription> m_fusedActivation{};
                publicoverride std::string ToString(void) $"BatchNormalizationTraining: Epsilon={Epsilon}";
