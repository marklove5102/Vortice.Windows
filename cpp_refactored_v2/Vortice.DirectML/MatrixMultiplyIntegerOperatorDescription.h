...
namespace DirectML {
        ...
        publicstruct MatrixMultiplyIntegerOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.MatrixMultiplyInteger; }
                ...
                publicoverride std::string ToString(void) $"MatrixMultiplyInteger";
