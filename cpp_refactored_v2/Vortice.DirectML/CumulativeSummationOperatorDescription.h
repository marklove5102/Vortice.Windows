...
namespace DirectML {
        ...
        publicstruct CumulativeSummationOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.CumulativeSummation; }
                ...
                public: bool m_hasExclusiveSum{};
                publicoverride std::string ToString(void) $"CumulativeSummation: Axis={Axis} AxisDirection={AxisDirection} HasExclusiveSum={HasExclusiveSum}";
