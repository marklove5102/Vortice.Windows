...
#ifndef VORTICE_ACTIVATIONLEAKYRELUOPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONLEAKYRELUOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationLeakyReluOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationLeakyRelu; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                public: float m_alpha{};
                publicoverride std::string ToString(void) $"ActivationLeakyRelu: Alpha={Alpha}";
...
#endif // VORTICE_ACTIVATIONLEAKYRELUOPERATORDESCRIPTION_H