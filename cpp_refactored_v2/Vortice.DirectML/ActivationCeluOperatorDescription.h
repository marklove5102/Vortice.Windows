...
#ifndef VORTICE_ACTIVATIONCELUOPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONCELUOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationCeluOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationCelu; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                public: float m_alpha{};
                publicoverride std::string ToString(void) $"ActivationCelu: Alpha={Alpha}";
...
#endif // VORTICE_ACTIVATIONCELUOPERATORDESCRIPTION_H