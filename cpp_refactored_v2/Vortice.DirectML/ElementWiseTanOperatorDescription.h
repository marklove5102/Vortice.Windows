...
#ifndef VORTICE_ELEMENTWISETANOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISETANOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseTanOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseTan; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseTan";
...
#endif // VORTICE_ELEMENTWISETANOPERATORDESCRIPTION_H