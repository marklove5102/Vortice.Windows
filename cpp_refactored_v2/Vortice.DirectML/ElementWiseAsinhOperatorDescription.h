...
#ifndef VORTICE_ELEMENTWISEASINHOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEASINHOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAsinhOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAsinh; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAsinh";
...
#endif // VORTICE_ELEMENTWISEASINHOPERATORDESCRIPTION_H