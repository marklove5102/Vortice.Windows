...
namespace DirectML {
        ...
        publicstruct ActivationParametricSoftplusOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationParametricSoftplus; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                public: float m_alpha{};
                public: float m_beta{};
                publicoverride std::string ToString(void) $"ActivationParametricSoftplus: Alpha={Alpha} Beta={Beta}";
