...
#ifndef VORTICE_ELEMENTWISECOSHOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISECOSHOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseCoshOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseCosh; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseCosh";
...
#endif // VORTICE_ELEMENTWISECOSHOPERATORDESCRIPTION_H