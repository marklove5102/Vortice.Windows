...
#ifndef VORTICE_MAXPOOLINGOPERATORDESCRIPTION_H
#define VORTICE_MAXPOOLINGOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct MaxPoolingOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.MaxPooling; }
                ...
                publicoverride std::string ToString(void) $"MaxPooling";
...
#endif // VORTICE_MAXPOOLINGOPERATORDESCRIPTION_H