...
#ifndef VORTICE_ELEMENTWISEACOSOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEACOSOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAcosOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAcos; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAcos";
...
#endif // VORTICE_ELEMENTWISEACOSOPERATORDESCRIPTION_H