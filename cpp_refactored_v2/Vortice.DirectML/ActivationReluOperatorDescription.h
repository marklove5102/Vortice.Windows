...
namespace DirectML {
        ...
        publicstruct ActivationReluOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationRelu; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                publicoverride std::string ToString(void) $"ActivationRelu";
