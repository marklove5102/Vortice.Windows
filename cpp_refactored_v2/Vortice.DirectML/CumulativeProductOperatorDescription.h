...
namespace DirectML {
        ...
        publicstruct CumulativeProductOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.CumulativeProduct; }
                ...
                public: bool m_hasExclusiveProduct{};
                publicoverride std::string ToString(void) $"CumulativeProduct: Axis={Axis} AxisDirection={AxisDirection} HasExclusiveProduct={HasExclusiveProduct}";
