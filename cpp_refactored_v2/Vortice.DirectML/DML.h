...
namespace DirectML {
        ...
        public static class DML
        {
            ...
            publicstatic IDMLDevice DMLCreateDevice(ID3D12Device d3d12Device, CreateDeviceFlags createDeviceFlags)
                {
                ...
                where T : IDMLDevice
            {
                ...
                return MarshallingHelpers.FromPointer<T>(nativePtr) ?? throw new NullReferenceException(void);
            }
