...
#ifndef VORTICE_ARGMINOPERATORDESCRIPTION_H
#define VORTICE_ARGMINOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ArgminOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Argmin; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public int[] Axes { get; set; }
                public: AxisDirection m_axisDirection{};
                publicoverride std::string ToString(void) $"Argmin: AxisDirection={AxisDirection}";
...
#endif // VORTICE_ARGMINOPERATORDESCRIPTION_H