...
namespace DirectML {
        ...
        publicstruct ActivationParameterizedReluOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationParameterizedRelu; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_slopeTensor{};
                public: TensorDescription m_outputTensor{};
                publicoverride std::string ToString(void) $"ActivationParameterizedRelu";
