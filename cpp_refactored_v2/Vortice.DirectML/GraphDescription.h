...
namespace DirectML {
        ...
        publicstruct GraphDescription
        {
                public: int32_t m_inputCount{};
                public: int32_t m_outputCount{};
                ...
                publicoverride std::string ToString(void) $"GraphDescription: Inputs={InputCount} Outputs={OutputCount} Nodes={Nodes.Length} InputEdges={InputEdges?.Length ?? 0} OutputEdges={OutputEdges.Length} IntermediateEdges={IntermediateEdges?.Length ?? 0}";
