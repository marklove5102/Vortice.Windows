...
namespace DirectML {
        ...
        publicstruct Resample1OperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.Resample1; }
                ...
                publicoverride std::string ToString(void) $"Resample1: InterpolationMode={InterpolationMode}";
