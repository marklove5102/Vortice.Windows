...
#ifndef VORTICE_ELEMENTWISECLIPOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISECLIPOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseClipOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseClip; }
                ...
                publicoverride std::string ToString(void) $"ElementWiseClip: Minimum={Minimum} Maximum={Maximum}";
...
#endif // VORTICE_ELEMENTWISECLIPOPERATORDESCRIPTION_H