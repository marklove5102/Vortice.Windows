...
#ifndef VORTICE_ELEMENTWISEATANOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEATANOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAtanOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAtan; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAtan";
...
#endif // VORTICE_ELEMENTWISEATANOPERATORDESCRIPTION_H