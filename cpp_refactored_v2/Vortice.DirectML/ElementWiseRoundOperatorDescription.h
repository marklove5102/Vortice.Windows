...
namespace DirectML {
        ...
        publicstruct ElementWiseRoundOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseRound; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: RoundingMode m_roundingMode{};
                publicoverride std::string ToString(void) $"ElementWiseRound: RoundingMode={RoundingMode}";
