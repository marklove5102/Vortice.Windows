...
#ifndef VORTICE_ELEMENTWISEERFOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEERFOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseErfOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseErf; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseErf";
...
#endif // VORTICE_ELEMENTWISEERFOPERATORDESCRIPTION_H