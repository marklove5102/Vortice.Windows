...
namespace DirectML {
        ...
        publicstruct LpPoolingOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.LpPooling; }
                ...
                public: int32_t m_p{};
                publicoverride std::string ToString(void) $"LpPooling: P={P}";
