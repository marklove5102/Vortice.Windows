...
#ifndef VORTICE_QUANTIZEDLINEARMATRIXMULTIPLYOPERATORDESCRIPTION_H
#define VORTICE_QUANTIZEDLINEARMATRIXMULTIPLYOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct QuantizedLinearMatrixMultiplyOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.QuantizedLinearMatrixMultiply; }
                ...
                publicoverride std::string ToString(void) $"QuantizedLinearMatrixMultiply";
...
#endif // VORTICE_QUANTIZEDLINEARMATRIXMULTIPLYOPERATORDESCRIPTION_H