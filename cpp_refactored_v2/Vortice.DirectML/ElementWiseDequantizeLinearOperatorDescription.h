...
namespace DirectML {
        ...
        publicstruct ElementWiseDequantizeLinearOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseDequantizeLinear; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_scaleTensor{};
                public: TensorDescription m_zeroPointTensor{};
                public: TensorDescription m_outputTensor{};
                publicoverride std::string ToString(void) $"ElementWiseDequantizeLinear";
