...
namespace DirectML {
        ...
        publicstruct RandomGeneratorOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.RandomGenerator; }
                public: TensorDescription m_inputStateTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<TensorDescription> m_outputStateTensor{};
                public: RandomGeneratorType m_type{};
                publicoverride std::string ToString(void) $"RandomGenerator: Type={Type}";
