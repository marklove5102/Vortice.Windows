...
#ifndef VORTICE_ELEMENTWISEATANHOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEATANHOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAtanhOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAtanh; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAtanh";
...
#endif // VORTICE_ELEMENTWISEATANHOPERATORDESCRIPTION_H