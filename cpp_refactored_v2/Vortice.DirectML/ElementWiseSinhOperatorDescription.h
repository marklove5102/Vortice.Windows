...
#ifndef VORTICE_ELEMENTWISESINHOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISESINHOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseSinhOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseSinh; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseSinh";
...
#endif // VORTICE_ELEMENTWISESINHOPERATORDESCRIPTION_H