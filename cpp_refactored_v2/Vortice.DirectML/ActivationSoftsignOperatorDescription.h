...
#ifndef VORTICE_ACTIVATIONSOFTSIGNOPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONSOFTSIGNOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationSoftsignOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationSoftsign; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                publicoverride std::string ToString(void) $"ActivationSoftsign";
...
#endif // VORTICE_ACTIVATIONSOFTSIGNOPERATORDESCRIPTION_H