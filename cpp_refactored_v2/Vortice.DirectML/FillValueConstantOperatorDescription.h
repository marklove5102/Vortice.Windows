...
namespace DirectML {
        ...
        publicstruct FillValueConstantOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.FillValueConstant; }
                public: TensorDescription m_outputTensor{};
                public: TensorDataType m_valueDataType{};
                public: ScalarUnion m_value{};
                publicoverride std::string ToString(void) $"FillValueConstant: ValueDataType={ValueDataType} Value={Value}";
