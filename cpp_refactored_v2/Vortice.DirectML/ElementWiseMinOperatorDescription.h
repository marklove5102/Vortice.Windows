...
namespace DirectML {
        ...
        publicstruct ElementWiseMinOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseMin; }
                public: TensorDescription m_aTensor{};
                public: TensorDescription m_bTensor{};
                public: TensorDescription m_outputTensor{};
                publicoverride std::string ToString(void) $"ElementWiseMin";
