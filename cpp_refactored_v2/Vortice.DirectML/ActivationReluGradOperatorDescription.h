...
namespace DirectML {
        ...
        publicstruct ActivationReluGradOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationReluGrad; }
                ...
                publicoverride std::string ToString(void) $"ActivationReluGrad";
