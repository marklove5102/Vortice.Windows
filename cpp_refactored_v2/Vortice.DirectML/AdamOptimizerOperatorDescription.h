...
namespace DirectML {
        ...
        publicstruct AdamOptimizerOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.AdamOptimizer; }
                public: TensorDescription m_inputParametersTensor{};
                public: TensorDescription m_inputFirstMomentTensor{};
                public: TensorDescription m_inputSecondMomentTensor{};
                public: TensorDescription m_gradientTensor{};
                public: TensorDescription m_trainingStepTensor{};
                public: TensorDescription m_outputParametersTensor{};
                public: TensorDescription m_outputFirstMomentTensor{};
                public: TensorDescription m_outputSecondMomentTensor{};
                public: float m_learningRate{};
                public: float m_beta1{};
                public: float m_beta2{};
                public: float m_epsilon{};
                publicoverride std::string ToString(void) $"AdamOptimizer: LearningRate={LearningRate} Beta1={Beta1} Beta2={Beta2} Epsilon={Epsilon}";
