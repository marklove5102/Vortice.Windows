...
#ifndef VORTICE_ELEMENTWISESQRTOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISESQRTOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseSqrtOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseSqrt; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseSqrt";
...
#endif // VORTICE_ELEMENTWISESQRTOPERATORDESCRIPTION_H