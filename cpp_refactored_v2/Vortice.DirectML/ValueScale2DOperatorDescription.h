...
namespace DirectML {
        ...
        publicstruct ValueScale2DOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ValueScale2D; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: float m_scale{};
                public float[] Bias { get; set; }
                publicoverride std::string ToString(void) $"ValueScale2D: Scale={Scale}";
