...
namespace DirectML {
        ...
        publicstruct ConvolutionIntegerOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ConvolutionInteger; }
                ...
                publicoverride std::string ToString(void) $"ConvolutionInteger: GroupCount={GroupCount}";
