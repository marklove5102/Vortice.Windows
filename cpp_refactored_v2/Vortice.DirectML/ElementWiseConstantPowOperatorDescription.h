...
#ifndef VORTICE_ELEMENTWISECONSTANTPOWOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISECONSTANTPOWOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseConstantPowOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseConstantPow; }
                ...
                publicoverride std::string ToString(void) $"ElementWiseConstantPow: Exponent={Exponent}";
...
#endif // VORTICE_ELEMENTWISECONSTANTPOWOPERATORDESCRIPTION_H