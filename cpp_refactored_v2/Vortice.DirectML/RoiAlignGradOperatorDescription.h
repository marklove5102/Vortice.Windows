...
namespace DirectML {
        ...
        publicstruct RoiAlignGradOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.RoiAlignGrad; }
                ...
                public: std::optional<TensorDescription> m_outputGradientTensor{};
                public: std::optional<TensorDescription> m_outputROIGradientTensor{};
                ...
                publicoverride std::string ToString(void) $"RoiAlignGrad: ReductionFunction={ReductionFunction} InterpolationMode={InterpolationMode} SpatialScaleX={SpatialScaleX} SpatialScaleY={SpatialScaleY} InputPixelOffset={InputPixelOffset} OutputPixelOffset={OutputPixelOffset} MinimumSamplesPerOutput={MinimumSamplesPerOutput} MaximumSamplesPerOutput={MaximumSamplesPerOutput} AlignRegionsToCorners={AlignRegionsToCorners}";
