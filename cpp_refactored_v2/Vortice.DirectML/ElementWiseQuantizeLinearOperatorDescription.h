...
namespace DirectML {
        ...
        publicstruct ElementWiseQuantizeLinearOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseQuantizeLinear; }
                ...
                publicoverride std::string ToString(void) $"ElementWiseQuantizeLinear";
