...
#ifndef VORTICE_ELEMENTWISEASINOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISEASINOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseAsinOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseAsin; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseAsin";
...
#endif // VORTICE_ELEMENTWISEASINOPERATORDESCRIPTION_H