...
#ifndef VORTICE_ACTIVATIONLINEAROPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONLINEAROPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationLinearOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationLinear; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                public: float m_alpha{};
                public: float m_beta{};
                publicoverride std::string ToString(void) $"ActivationLinear: Alpha={Alpha} Beta={Beta}";
...
#endif // VORTICE_ACTIVATIONLINEAROPERATORDESCRIPTION_H