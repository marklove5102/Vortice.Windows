...
#ifndef VORTICE_AVERAGEPOOLINGOPERATORDESCRIPTION_H
#define VORTICE_AVERAGEPOOLINGOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct AveragePoolingOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.AveragePooling; }
                ...
                publicoverride std::string ToString(void) $"AveragePooling: IncludePadding={IncludePadding}";
...
#endif // VORTICE_AVERAGEPOOLINGOPERATORDESCRIPTION_H