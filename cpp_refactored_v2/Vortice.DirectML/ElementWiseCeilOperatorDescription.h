...
#ifndef VORTICE_ELEMENTWISECEILOPERATORDESCRIPTION_H
#define VORTICE_ELEMENTWISECEILOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ElementWiseCeilOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ElementWiseCeil; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: std::optional<ScaleBias> m_scaleBias{};
                publicoverride std::string ToString(void) $"ElementWiseCeil";
...
#endif // VORTICE_ELEMENTWISECEILOPERATORDESCRIPTION_H