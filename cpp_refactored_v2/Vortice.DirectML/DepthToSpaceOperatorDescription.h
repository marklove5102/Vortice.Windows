...
namespace DirectML {
        ...
        publicstruct DepthToSpaceOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.DepthToSpace; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_outputTensor{};
                public: int32_t m_blockSize{};
                publicoverride std::string ToString(void) $"DepthToSpace: BlockSize={BlockSize}";
