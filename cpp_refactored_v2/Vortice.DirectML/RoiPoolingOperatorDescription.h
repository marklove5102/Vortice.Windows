...
namespace DirectML {
        ...
        publicstruct RoiPoolingOperatorDescription : : IOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.RoiPooling; }
                public: TensorDescription m_inputTensor{};
                public: TensorDescription m_roiTensor{};
                public: TensorDescription m_outputTensor{};
                public: float m_spatialScale{};
                public: Size2D m_pooledSize{};
                publicoverride std::string ToString(void) $"RoiPooling: SpatialScale={SpatialScale} PooledSize={PooledSize}";
