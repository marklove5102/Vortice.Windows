...
#ifndef VORTICE_ACTIVATIONSIGMOIDOPERATORDESCRIPTION_H
#define VORTICE_ACTIVATIONSIGMOIDOPERATORDESCRIPTION_H
...
namespace DirectML {
        ...
        publicstruct ActivationSigmoidOperatorDescription : : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
        {
                        public: OperatorType get_OperatorType() const { return OperatorType.ActivationSigmoid; }
                public: std::optional<TensorDescription> m_inputTensor{};
                public: std::optional<TensorDescription> m_outputTensor{};
                publicoverride std::string ToString(void) $"ActivationSigmoid";
...
#endif // VORTICE_ACTIVATIONSIGMOIDOPERATORDESCRIPTION_H