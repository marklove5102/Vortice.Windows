...
namespace Dxc {
        ...
        public static class Dxc
        {
            ...
            [MethodImpl(MethodImplOptions.NoInlining)]
            publicstatic IDxcUtils CreateDxcUtils(void)
                {
                return DxcCreateInstance<IDxcUtils>(CLSID_DxcUtils);
            }
            [MethodImpl(MethodImplOptions.NoInlining)]
            publicstatic IDxcAssembler CreateDxcAssembler(void)
                {
                return DxcCreateInstance<IDxcAssembler>(CLSID_DxcAssembler);
            }
            [MethodImpl(MethodImplOptions.NoInlining)]
            publicstatic IDxcLinker CreateDxcLinker(void)
                {
                return DxcCreateInstance<IDxcLinker>(CLSID_DxcLinker);
            }
            [MethodImpl(MethodImplOptions.NoInlining)]
            publicstatic IDxcContainerReflection CreateDxcContainerReflection(void)
                {
                return DxcCreateInstance<IDxcContainerReflection>(CLSID_DxcContainerReflection);
            }
            publicstatic void LoadDxil(void)
                {
                try
                {
            ...
            [DllImport("kernel32")]
            privatestatic void* LoadLibrary(const std::string& fileName);
        }
