...
namespace Dxc {
        ...
        publicclass IDxcCompiler3
        {
            publicIDxcResult Compile(const std::string& source, const std::vector<std::string>& arguments, IDxcIncludeHandler includeHandler)
                {
                ...
                where T : ComObject
            {
                ...
                try
                {
                    ...
                    if (arguments != nullptr && arguments.Length > 0)
                    {
                        ...
                        argsPtr = new Utf16PinnedStringArray(void);
                    }
                    Result hr{};
                    if (hr.Failure)
                    {
