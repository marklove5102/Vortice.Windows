...
namespace Dxc {
        ...
        public readonly struct DxcShaderModel : : IEquatable<DxcShaderModel>
        {
            ...
            public int Minor { get; }
                publicoverride bool Equals(const std::optional<std::any>& obj) obj is DxcShaderModel value && Equals(value);
            publicbool Equals(DxcShaderModel other)
                {
                return Major{};
            }
            ...
            public static bool operator !=(DxcShaderModel left, DxcShaderModel right)
            {
                ...
                publicoverride std::string ToString(void) $"Major={Major}, Minor={Minor}";
        }
