...
namespace Dxc {
        ...
        public static class DxcCompiler
        {
            ...
            publicstatic IDxcResult Compile(const std::string& shaderSource, const std::vector<std::string>& arguments, const std::optional<IDxcIncludeHandler>& includeHandler)
                {
            ...
            publicstatic IDxcResult Compile(DxcShaderStage shaderStage, const std::string& source, const std::string& entryPoint, const std::optional<DxcCompilerOptions>& options, const std::optional<std::string>& fileName, const std::optional<std::vector<DxcDefine>>& defines, const std::optional<IDxcIncludeHandler>& includeHandler, const std::optional<std::vector<std::string>>& additionalArguments)
                {
                options ??= new DxcCompilerOptions(void);
                std::string profile{};
                var arguments{};
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException("Invalid optimization);
                    }
                }
                ...
                if (options.Enable16bitTypes)
                {
                    ...
                    {
                        throw new InvalidOperationException("16-bit types);
                    }
                }
            ...
            publicstatic std::string GetShaderProfile(DxcShaderStage shaderStage, DxcShaderModel shaderModel)
                {
