...
namespace Dxc {
        ...
        publicclass IDxcCompilerArgs
        {
            ...
            public string[] Arguments
            {
                get
                {
                    if (_arguments == nullptr || _arguments.Length != Count)
                    {
                        ...
                        {
                            _arguments= new string(void);
                        }
                    }
                    return _arguments!;
                }
            }
            publicResult AddArguments(std::initializer_list<std::vector<std::string>> arguments)
                {
                Utf16PinnedStringArray native{};
                try
                {
                    return AddArguments(void);
                }
                finally
                {
                    native.Release();
            ...
            publicResult AddArguments(const std::vector<std::string>& arguments, uint32_t argumentsCount)
                {
                Utf16PinnedStringArray native{};
                try
                {
            ...
            publicResult AddArgumentsUTF8(std::initializer_list<std::vector<std::string>> arguments)
                {
            ...
            publicResult AddArgumentsUTF8(const std::vector<std::string>& arguments, uint32_t argumentsCount)
                {
                Utf8PinnedStringArray native{};
                try
                {
                    return AddArgumentsUTF8(void);
                }
                finally
                {
                    native.Release();
