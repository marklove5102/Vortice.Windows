...
namespace Dxc {
        ...
        public static class Dxil
        {
            ...
            publicstatic IDxcValidator CreateDxilValidator(void)
                {
            ...
            public static unsafe SharpGen.Runtime.Result DxcCreateInstance(GUID rclsid, GUID riid, void*& ppv)
                {
            ...
            private unsafe static int32_t DxcCreateInstance_(void* _rclsid, void* _riid, void* _ppv);
        }
