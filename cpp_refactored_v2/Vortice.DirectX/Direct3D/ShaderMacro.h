...
namespace Direct3D {
        ...
        publicstruct ShaderMacro : : IEquatable<ShaderMacro>
        {
            ...
            public readonly bool Equals(ShaderMacro other)
                ...
                public override readonly bool Equals(const std::optional<std::any>& obj) obj is ShaderMacro value && Equals(value);
            public override readonly int32_t GetHashCode(void) HashCode.Combine(Name, Definition);
