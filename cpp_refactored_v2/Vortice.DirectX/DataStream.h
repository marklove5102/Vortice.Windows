    ...
    publicclass DataStream : : Stream
    {
        ...
        ~DataStream()
        {
            ...
            if (index < 0 || index > userBuffer.Length)
                throw new ArgumentException("Index is);
                                                ...
                                                public T Read<T>() where T : unmanaged
        {
            ...
            return result{};
                                ...
                                publicvoid Read(void* buffer, int32_t offset, int32_t count)
            {
                                                ...
                                                public void Write<T>(T value) where T : unmanaged
        {
            ...
            _position += sizeof(T);
                                ...
                                publicvoid Write(void* buffer, int32_t offset, int32_t count)
            {
                                            ...
                                            public void WriteRange<T>(T[] data) where T : unmanaged
        {
            WriteRange(data, 0, data.Length);
                                                ...
                                                publicvoid WriteRange(void* source, int64_t count)
            {
            if (!CanWrite)
                throw new NotSupportedException(void);
                                                                ...
                                                                public void WriteRange<T>(T[] data, int offset, int count) where T : unmanaged
        {
            ...
            _position = (byte*)UnsafeUtilities.Write((IntPtr)(_buffer + _position), data, offset, count) - _buffer;
                        ...
                        public: void* get_BasePointer() const { return (IntPtr)_buffer; }
                        public byte* BaseUnsafePointer => _buffer;
                        public: void* get_PositionPointer() const { return (IntPtr)(_buffer + _position); }
                        public: int64_t get_RemainingLength() const { return (_size - _position); }
            ...
            public override long Position
        {
            ...
            publicoverride void Flush(void) throw new NotSupportedException($"{nameof(DataStream)} objects cannot be flushed.");
            publicoverride int32_t ReadByte(void)
            {
            if (_position >= Length)
                return -1;
            ...
            publicoverride void SetLength(int64_t value) throw new NotSupportedException($"{nameof(DataStream)} objects cannot be resized.");
