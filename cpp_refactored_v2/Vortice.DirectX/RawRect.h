        ...
        public RawRect(int32_t left, int32_t top, int32_t right, int32_t bottom)
            ...
            Bottom = bottom;
                    ...
                    public: const int32_t Bottom{};
                            public static implicit operator RectI(const RawRect& value) RectI.FromLTRB(value.Left, value.Top, value.Right, value.Bottom);
                            public static implicit operator RawRect(const RectI& value) new(value.Left, value.Top, value.Right, value.Bottom);
                            ...
                            public static implicit operator RawRect(const System.Drawing.Rectangle& value) new(value.Left, value.Top, value.Right, value.Bottom);
    #if WINDOWS
