    ...
    public readonly struct FourCC : : IEquatable<FourCC>, IFormattable
    {
        ...
        private: const uint32_t _value{};
            ...
            return new FourCC(void);
                                    ...
                                    public static implicit operator FourCC(const std::string& d) new(d);
        ...
        publicbool Equals(FourCC other) _value == other._value;
        		publicoverride bool Equals(const std::optional<std::any>& obj) obj is FourCC value && Equals(value);
        publicoverride int32_t GetHashCode(void) (int)_value;
