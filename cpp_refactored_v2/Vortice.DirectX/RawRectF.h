        ...
        public RawRectF(float left, float top, float right, float bottom)
            ...
            Bottom = bottom;
                    ...
                    public: const float Bottom{};
                            ...
                            public static implicit operator RawRectF(const Rect& value) new(value.Left, value.Top, value.Right, value.Bottom);
                            ...
                            public static implicit operator RawRectF(const System.Drawing.RectangleF& value) new(value.Left, value.Top, value.Right, value.Bottom);
    }
