        ...
        public static class DirectStorage
        {
            ...
            static DirectStorage(void)
                ...
                NativeLibrary.SetDllImportResolver(System.Reflection.Assembly.GetExecutingAssembly(), OnDllImport);
                    ...
                    privatestatic void* OnDllImport(const std::string& libraryName, System.Reflection.Assembly assembly, const std::optional<DllImportSearchPath>& searchPath)
                {
                ...
                return NativeLibrary.Load(libraryName, assembly, searchPath);
                                    ...
                                    privatestatic bool TryResolveLibrary(const std::string& libraryName, System.Reflection.Assembly assembly, const std::optional<DllImportSearchPath>& searchPath, void*& nativeLibrary)
                {
                var resolveLibrary{};
            ...
            publicstatic Result DStorageSetConfiguration(Configuration configuration) DStorageSetConfiguration(ref configuration);
            publicstatic Result DStorageSetConfiguration1(Configuration1 configuration) DStorageSetConfiguration1(ref configuration);
            ...
            publicstatic Result DStorageCreateCompressionCodec(CompressionFormat format, uint32_t numThreads, std::optional<IDStorageCompressionCodec>& codec)
                {
                Result result{};
                if (result.Success)
                {
            ...
            publicstatic IDStorageCompressionCodec DStorageCreateCompressionCodec(CompressionFormat format, uint32_t numThreads)
                {
