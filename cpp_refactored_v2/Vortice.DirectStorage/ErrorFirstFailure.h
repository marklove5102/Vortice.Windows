...
namespace DirectStorage {
        ...
        publicstruct ErrorFirstFailure
        {
                        public: const Result HResult{};
                        public: const CommandType CommandType{};
            private: Union _union{};
                        public: ErrorParametersRequest m_request{};
                public: ErrorParametersRequest get_Request() const { return var result{};
                    result.__MarshalFrom(ref _union.Request);
                    return result{};; }
                        public: ErrorParametersStatus m_status{};
                public: ErrorParametersStatus get_Status() const { return var result{};
                    result.__MarshalFrom(ref _union.Status);
                    return result{};; }
                        public: ErrorParametersSignal m_signal{};
                public: ErrorParametersSignal get_Signal() const { return var result{};
