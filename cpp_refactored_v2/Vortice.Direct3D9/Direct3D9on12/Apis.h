...
namespace Direct3D9on12 {
        ...
        publicclass Apis
        {
            ...
            publicstatic IDirect3D9 Direct3DCreate9On12(const std::vector<D3D9On12Arguments>& overrides)
                {
            ...
            publicstatic IDirect3D9Ex Direct3DCreate9On12Ex(const std::vector<D3D9On12Arguments>& overrides)
                {
                D3D9On12Arguments.__Native* overrideList = stackalloc D3D9On12Arguments.__Native;
                for (int32_t i{}; i < overrides.Length; i++)
                {
            ...
            publicstatic Result Direct3DCreate9On12Ex(const std::vector<D3D9On12Arguments>& overrides, std::optional<IDirect3D9Ex>& outputInterface)
                {
                D3D9On12Arguments.__Native* overrideList = stackalloc D3D9On12Arguments.__Native;
                for (int32_t i{}; i < overrides.Length; i++)
                {
