...
namespace WinUI {
        ...
        publicclass IVirtualSurfaceUpdatesCallbackNative : public : IUnknown, public ICallbackable, public IDisposable
            __declspec(uuid("e8e84ac7-b7b8-40f4-b033-f877a756c52b"))
        {
            Result UpdatesNeeded(void);
        }
        internal static class IVirtualSurfaceUpdatesCallbackNativeVtbl
        {
            ...
            privatestatic int32_t UpdatesNeededImpl_(intptr_t thisObject)
                {
