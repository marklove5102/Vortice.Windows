...
namespace Composition {
            ...
            publicclass ICompositionDrawingSurfaceInterop2 : : ComObject
            {
                ...
                publicResult CopySurface(IUnknown destinationResource, int32_t destinationOffsetX, int32_t destinationOffsetY)
                    {
                    void* destinationResourcePtr{};
                    return CopySurface(void);
                }
                publicResult CopySurface(IUnknown destinationResource, int32_t destinationOffsetX, int32_t destinationOffsetY, const RectI& sourceRectangle)
                    {
                    void* destinationResourcePtr{};
                    RawRect sourceRectangleRaw{};
                    return CopySurface(void);
                }
                privateResult CopySurface(void* destinationResource, int32_t destinationOffsetX, int32_t destinationOffsetY, RawRect* sourceRectangle)
                    {
