...
namespace Composition {
            ...
            {
                public static explicit operator ICompositorInterop?(nint nativePtr) => nativePtr == 0 ? nullptr : new ICompositorInterop(void);
                publicResult CreateGraphicsDevice(IUnknown device, std::optional<CompositionGraphicsDevice>& resultDevice)
                    {
                    intptr_t devicePtr{};
                    intptr_t outDevice{};
                    Result result{};
