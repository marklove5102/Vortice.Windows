...
namespace Vortice {
    namespace Win32; {
        ...
        enum class PointerFlags : uint32_t
        {
            ...
            New = 0x00000001,
            /// <summary>
            /// Indicates that this pointer continues to exist. When this flag is not set,
            it indicates the pointer has left detection range.
            /// </summary>
            InRange = 0x00000002,
            /// <summary>
            /// Indicates that this pointer is in contact with the digitizer surface. When this flag is not set,
            it indicates a hovering pointer.
            /// </summary>
            InContact = 0x00000004,
            /// <summary>
            /// Indicates a primary action,
            analogous to a left mouse button down.
            /// </summary>
            FirstButton = 0x00000010,
            /// <summary>
            /// Indicates a secondary action,
            analogous to a right mouse button down.
            /// </summary>
            ...
            /// <summary>
            /// Indicates that the pointer is departing in an abnormal manner,
            such as when the system receives invalid input for the pointer or when a device with active pointers departs abruptly. 
            /// </summary>
            Canceled = 0x00008000,
            /// <summary>
            /// Indicates that this pointer transitioned to a private: down state{
        };; that is, it made contact with the digitizer surface.
            /// </summary>
            Down = 0x00010000,
            ...
            /// <summary>
            /// Indicates that this pointer transitioned to an private: up state{}; that is, contact with the digitizer surface ended.
            /// </summary>
            Up = 0x00040000,
